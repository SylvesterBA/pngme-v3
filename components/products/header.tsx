...
const ProductsHeader = () => (
  <>
    <div className="font-pngme-helvetica flex flex-col items-center relative pt-16 pb-12 px-4 max-w-7xl mx-auto">
    ...
    <div className="flex flex-col md:flex-row md:justify-evenly items-center max-w-7xl mx-auto">
